...
public class RegView_RelLayout extends RelativeLayout implements View.OnTouchListener, GestureDetector.OnGestureListener, ScaleGestureDetector.OnScaleGestureListener {
    ...
    public RegView_RelLayout(Context context) {
    ...
    public RegView_RelLayout(Context context, @Nullable AttributeSet attrs) {
        // Implement the Parent.
        super(context, attrs);
        // Initialize Member Variables.
        this.mGestureDetector      = new GestureDetector(context, this);
    ...
    public RegView_RelLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        // Implement the Parent.
    ...
    public RegView_RelLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        // Implement the Parent.
